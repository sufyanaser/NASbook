...
export const APP_COMMANDS: readonly AppCommand[] = [
  ...
  { id: "saveNasbk", nameEn: "Save as NASBK", nameAr: "حفظ بصيغة NASBK", category: "app", defaultShortcut: "Ctrl+Shift+S" },
  ...
  { id: "toggleStrike", nameEn: "Toggle Strikethrough", nameAr: "تبديل نص يتوسطه خط", category: "editor", defaultShortcut: "Ctrl+Shift+X" },
